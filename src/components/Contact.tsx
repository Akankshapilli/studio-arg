    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div>
          ...
          >
            {[
              { label: "Email", value: "hello@Studioarg.com", icon: "✉" },
              {
                label: "Phone",
                value: "+91 88855 08822",
                icon: "✆",
              },
        ...
        >
          ...
          <button
            type="submit"
            className="self-start font-[family-name:var(--font-jost)] text-[11px] tracking-[0.22em] uppercase bg-[#1A1A1A] text-[#F6F1E9] px-10 py-4 hover:bg-[#B08D57] transition-colors duration-300 mt-2"
          >
